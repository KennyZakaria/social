  ...
  template: `
    <div class="page">
      ...
      <div class="page-header">
        ...
        <a class="btn-ghost ml-auto" routerLink="/module/mutuelle/historique">Historique courrier</a>
      </div>
      ...
      <div class="card">
        ...
        <div class="table-wrap">
          <table>
            <thead>
              <tr><th>Adhérent</th><th>Grade</th><th>Matricule</th><th>CIN</th><th>Mle BR</th><th>Unité</th><th>Action</th></tr>
            </thead>
            <tbody>
              <tr *ngFor="let adherent of adherents">
                ...
                <td>
                  <a class="btn-primary btn-small" [routerLink]="['/module/mutuelle/dossier', adherent.id]">Ajouter dossier mutuelle</a>
                </td>
              </tr>
