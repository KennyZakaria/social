...
@RestController
@RequestMapping("/api/mutuelle/adherents")
@RequiredArgsConstructor
@PreAuthorize("@userAccessService.canAccessModule(authentication, 'MUTUELLE')")
public class MutuelleAdherentController {

    private final AdherentService adherentService;

    @GetMapping
    public AdherentPageResponse search(@RequestParam(required = false) String search,
